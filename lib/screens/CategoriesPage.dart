...
class _CategoriesPageState extends State<CategoriesPage> {
    ...
    try {
      ...
      List<Map<String, dynamic>> categories = snapshot.docs.map((doc) {
        return {
          ...
          "iconName": doc['iconName'], // The name of the icon stored in Firestore
          "name": doc['name'], // The name of the category
          "iconColor": doc['iconColor'], // Assuming the color is stored as a hex string
        };
      }).toList();
  ...
  Future<void> deleteCategory(String id) async {
    try {
      ...
      setState(() {
        _categoryItems.removeWhere((item) => item['id'] == id);
      });
    } catch (e) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              child: Text('Yes'),
              onPressed: () {
                deleteCategory(id); // Delete the category
                Navigator.of(context).pop(); // Close the dialog
              },
            ),
          ],
          ...
          SafeArea(
            child: Column(
              children: [
                // AppBar
                Padding(
                  padding: const EdgeInsets.only(left: 8.0, right: 8.0, top: 5.0, bottom: 50),
                  child: Row(
                      ...
                      children: [
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Center(
                                                      child: Icon(
                                                        ...
                                                        color: Color(int.parse(item['iconColor'].replaceFirst('#', '0xFF'))),
                                                        size: 30,
                                                      ),
                                                    ),
                                                  ),
                                                ...
                                                GestureDetector(
                                                  onTap: () {
                                                    _showDeleteConfirmationDialog(item['id']); // Show confirmation dialog
                                                  },
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                              top: 15.0, right: 15.0, left: 15.0, bottom: 130.0),
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.of(context)
                                  ...
                                  .then((_) {
                                    fetchCategories(); // Fetch categories after returning from AddCategoryPage
                                  });
                            },

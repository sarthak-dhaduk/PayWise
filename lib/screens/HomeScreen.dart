          ...
          try {
            ...
            if (isSelected[0]) {
              ...
              startDate = now.subtract(
                  Duration(days: now.weekday - 1)); // Start of the week
            ...
            QuerySnapshot transactionsSnapshot = await FirebaseFirestore
                .instance
                .collection('transactions')
                .where('email', isEqualTo: email)
...
class FilterBar extends StatelessWidget {
  ...
  FilterBar({required this.isSelected, required this.onFilterChanged});

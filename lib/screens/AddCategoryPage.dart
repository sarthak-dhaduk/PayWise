...
class _IconSearchMenuState extends State<IconSearchMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromRGBO(255, 181, 61, 1),
      appBar: AppBar(
        title: Text(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(16)),
                        color: Color.fromRGBO(238, 229, 255, 0.732),
                      ),
                          ...
                          Center(
                            child: Column(
                              ...
                              children: [
                                Icon(iconData,
                                    color: widget
                                        .iconColor), // Apply the selected color
                                SizedBox(height: 8),
                                Text(
                                  iconName,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontSize: 12, color: widget.iconColor),
                                ),
                              ],
                            ),
                          ),
  ...
  void _showColorPicker() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: Color.fromRGBO(126, 61, 255, 1),
          title: const Text(
            'Category Color Should Be ,',
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        child: GestureDetector(
                          onTap:
                              _showColorPicker, // Trigger color picker dialog
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(16),
                              border: Border.all(color: Colors.white),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(
                                  ...
                                  color:
                                      selectedIconColor, // Apply selected color
                                ),
                                SizedBox(width: 10),
                                Text(
                                  'Colors',

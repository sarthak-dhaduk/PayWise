...
class _CustomFilterModalState extends State<CustomFilterModal> {
  ...
  List<String> categories = []; // To store fetched categories dynamically
...
class _TransactionpageState extends State<Transactionpage> {
  ...
  final Map<String, IconData> _flutterIcons = {
    ...
    'wb_twighlight': Icons.wb_twilight,
    'wc': Icons.wc,
    'web': Icons.web,
  ...
  Future<List<Transaction>> fetchTransactions(
    ...
    if (filters != null) {
      ...
      filters.forEach((key, value) {
        if (value) {
          if (key == 'Income' || key == 'Expense' || key == 'Transfer') {
    ...
    for (var doc in querySnapshot.docs) {
      ...
      if (data['transaction_type'] == "Transfer") {
        title = '${data['from_account']} to ${data['to_account']}';
      } else {
      ...
      IconData icon = _flutterIcons[iconName] ?? Icons.account_tree_rounded;
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      statusBarColor: Color.fromARGB(
          255, 255, 255, 255), // Set the status bar color to black
            ...
            builder: (context, snapshot) {
              ...
              transactions.sort((a, b) {
                ...
                return dateComparison == 0
                    ? b.time
                        .compareTo(a.time) // Sort by time within the same date
                    : dateComparison;
              });
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Format the current transaction's date
                      String currentDate =
                          _formatTransactionDate(transaction.date);
                      String? previousDate;

                      // Format the previous transaction's date, if available
                      if (previousTransaction != null) {
                        previousDate =
                            _formatTransactionDate(previousTransaction.date);
                      }

                      // Show the date header if the date is different from the previous one
            ...
            leading: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: transaction.transactionType == "Income"
                    ? Color.fromRGBO(0, 168, 107, 1).withOpacity(0.1)
                    : transaction.transactionType == "Expense"
                        ? Color.fromRGBO(253, 60, 74, 1).withOpacity(0.1)
                        : Color.fromRGBO(0, 119, 255, 1).withOpacity(0.1),
              ),
              child: Icon(
                transaction.icon,
                color: transaction.transactionType == "Income"
